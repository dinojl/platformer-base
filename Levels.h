...
namespace lvl {
	...
	std::map<std::string, Level> init() {
		...
		Manifest.insert(std::pair<std::string, Level>("Brickworld", Level((
			...
			"BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB"
			"BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB"
			"BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB"), 63, 20, 1, 1, true, "Cave")));
		...
		Manifest.insert(std::pair<std::string, Level>("Cave", Level((
			...
			"####################............BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB"), 64, 24, 1, 1, true, "Debug")));
